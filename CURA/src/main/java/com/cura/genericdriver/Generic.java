 ...
 * 
 */
package com.cura.genericdriver;
...
/**
 * @author maxxmuthu added on 29th Dec 2022
 *
 */
public class Generic extends BaseClass {
	...
	public void clickobject(WebDriver driver, WebElement ele) {

		ele.click();

	}
	
	public String fullpageScreenshot(WebDriver driver,String filename) {

		//Full page screen shot using Ashot API.	
		 String dateName = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
		  ...
		  try {
		   ImageIO.write(screenshot.getImage(), "png",
		     new File(System.getProperty("user.dir") + "\\ScreenShot\\"+ filename + "_"+ dateName + ".png"));
		  } 
	...
	public void webElementScreenshot(WebDriver driver,WebElement ele, String filename) {
	...
	public void croppingScreenshot(WebDriver driver,WebElement ele, String filename) throws IOException {
		...
		String dateName = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
		  ...
		  // Copy the element screenshot to desired location
		  File screenshotLocation = new File(System.getProperty("user.dir") + "\\ScreenShot\\"+ filename + "_"+ dateName + ".png");
