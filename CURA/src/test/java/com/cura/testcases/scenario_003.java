 ...
 *
 */
public class scenario_003 extends BaseClass {
    ...
    public void startpageAndlogin(String data[]) throws Throwable {
		...
		Log.startTestCase("scenario_003");
		Log.info("This is scenario_003");
		...
		Log.info("Selecting the Seoul Facility");
		homepage.Facility_Seoul();
